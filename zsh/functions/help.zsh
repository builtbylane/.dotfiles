function help() {
  ...
  show_git_help() {
    ...
    printf "\033[1;33mgopen\033[0m       - Open current GitHub repository in browser\n"
    printf "\033[1;33mgpr\033[0m         - Open current branch's PR page\n"
    printf "\033[1;33mgclonecd\033[0m    - Clone and cd into repo: gclonecd https://github.com/user/repo\n"
    printf "\033[1;33mgclean\033[0m      - Cleanup merged branches (protects important branches)\n"
    printf "\033[1;33mcl\033[0m          - Copy last commit message to clipboard\n"
    printf "\n"
    printf "\033[1;33mgit s\033[0m       - Short status\n"
    printf "\033[1;33mgit l\033[0m       - Pretty log with graph\n"
